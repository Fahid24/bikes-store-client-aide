...
const Product = ({ product, p }) => {
    ...
    return (
        <div className='col-12 col-sm-12 col-md-4 col-lg-3 col-xl-3 col-xxl-4 d-flex justify-content-center '>
            <Card className='text-center border rounded ' style={{ width: '18rem' }}>
                <Card.Img className='pic img-fluid' variant="top" src={img} style={{ widht: '300px' }} />
                <Card.Body>
